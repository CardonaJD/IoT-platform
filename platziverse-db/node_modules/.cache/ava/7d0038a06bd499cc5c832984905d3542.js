...
test.serial('Setup', t => {
  ...
  t.true(_rec3._expr(_rec3._capt(_rec3._capt(_rec3._capt(AgentStub, "arguments/0/callee/object/object").hasMany, "arguments/0/callee/object").calledWidth(_rec3._capt(MetricStub, "arguments/0/arguments/0")), "arguments/0"), {
    content: "t.true(AgentStub.hasMany.calledWidth(MetricStub), 'Arguments should be the MetricModel')",
    filepath: "tests\\agent-tests.js",
    line: 43,
    ast: "{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"t\",\"range\":[0,1]},\"property\":{\"type\":\"Identifier\",\"name\":\"true\",\"range\":[2,6]},\"computed\":false,\"range\":[0,6]},\"arguments\":[{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"AgentStub\",\"range\":[7,16]},\"property\":{\"type\":\"Identifier\",\"name\":\"hasMany\",\"range\":[17,24]},\"computed\":false,\"range\":[7,24]},\"property\":{\"type\":\"Identifier\",\"name\":\"calledWidth\",\"range\":[25,36]},\"computed\":false,\"range\":[7,36]},\"arguments\":[{\"type\":\"Identifier\",\"name\":\"MetricStub\",\"range\":[37,47]}],\"range\":[7,48]},{\"type\":\"StringLiteral\",\"value\":\"Arguments should be the MetricModel\",\"range\":[50,87]}],\"range\":[0,88]}",
    tokens: "[{\"type\":{\"label\":\"name\"},\"value\":\"t\",\"range\":[0,1]},{\"type\":{\"label\":\".\"},\"range\":[1,2]},{\"type\":{\"label\":\"true\"},\"value\":\"true\",\"range\":[2,6]},{\"type\":{\"label\":\"(\"},\"range\":[6,7]},{\"type\":{\"label\":\"name\"},\"value\":\"AgentStub\",\"range\":[7,16]},{\"type\":{\"label\":\".\"},\"range\":[16,17]},{\"type\":{\"label\":\"name\"},\"value\":\"hasMany\",\"range\":[17,24]},{\"type\":{\"label\":\".\"},\"range\":[24,25]},{\"type\":{\"label\":\"name\"},\"value\":\"calledWidth\",\"range\":[25,36]},{\"type\":{\"label\":\"(\"},\"range\":[36,37]},{\"type\":{\"label\":\"name\"},\"value\":\"MetricStub\",\"range\":[37,47]},{\"type\":{\"label\":\")\"},\"range\":[47,48]},{\"type\":{\"label\":\",\"},\"range\":[48,49]},{\"type\":{\"label\":\"string\"},\"value\":\"Arguments should be the MetricModel\",\"range\":[50,87]},{\"type\":{\"label\":\")\"},\"range\":[87,88]}]",
    visitorKeys: _powerAssertVisitorKeys
  ...
  t.true(_rec5._expr(_rec5._capt(_rec5._capt(_rec5._capt(MetricStub, "arguments/0/callee/object/object").belongsTo, "arguments/0/callee/object").calledWith(_rec5._capt(AgentStub, "arguments/0/arguments/0")), "arguments/0"), {
    content: "t.true(MetricStub.belongsTo.calledWith(AgentStub), 'Arguments should be the the Agentmodel')",
    filepath: "tests\\agent-tests.js",
    line: 45,
